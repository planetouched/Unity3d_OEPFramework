...
namespace Assets.logic.core.factories
{
    public class Factory : IFactory
    {
        ...
        public object Build<T1>(string key, T1 param)
        {
            return Activator.CreateInstance(GetVariant(key), param);
        }

        public object Build<T1, T2>(string key, T1 param, T2 param2)
        {
            return Activator.CreateInstance(GetVariant(key), param, param2);
        }

        public object Build<T1, T2, T3>(string key, T1 param, T2 param2, T3 param3)
        {
            return Activator.CreateInstance(GetVariant(key), param, param2, param3);
        }

        public object Build<T1, T2, T3, T4>(string key, T1 param, T2 param2, T3 param3, T4 param4)
        {
            return Activator.CreateInstance(GetVariant(key), param, param2, param3, param4);
        }

        public object Build<T1, T2, T3, T4, T5>(string key, T1 param, T2 param2, T3 param3, T4 param4, T5 param5)
        {
