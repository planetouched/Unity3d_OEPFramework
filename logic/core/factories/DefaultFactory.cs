...
namespace logic.core.factories
{
    public class DefaultFactory : IDefaultFactory
    {
        ...
        public object Build<T1>(Type type, T1 param1)
        {
            return Activator.CreateInstance(type, param1);
        }

        public object Build<T1, T2>(Type type, T1 param1, T2 param2)
        {
            return Activator.CreateInstance(type, param1, param2);
        }

        public object Build<T1, T2, T3>(Type type, T1 param1, T2 param2, T3 param3)
        {
            return Activator.CreateInstance(type, param1, param2, param3);
        }

        public object Build<T1, T2, T3, T4>(Type type, T1 param1, T2 param2, T3 param3, T4 param4)
        {
            return Activator.CreateInstance(type, param1, param2, param3, param4);
        }

        public object Build<T1, T2, T3, T4, T5>(Type type, T1 param1, T2 param2, T3 param3, T4 param4, T5 param5)
        {
